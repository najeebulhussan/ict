    ...
    return (
        <>
            ...
            <header className={`main-header header-style-two ${scroll ? "fixed-header" : ""}`}>
                <div className="header-top-two centred">
                    <div className="auto-container">
                        <div className="text">
                            <h6>Trade with Confidence: Obtain Funding Today <Link href="/index-2"><i className="flaticon-right-arrow"></i>Get Funded Now</Link></h6>
                        </div>
                    </div>
                </div>
                {/* header lower */}
