  ...
  return (
    <>
        <section className="about-style-three">
            <div className="bg-layer" style={{ backgroundImage: "url(assets/images/background/about-bg.jpg)" }}></div>
                            ...
                            <div className="inner-box">
                                <div className="single-item">
                                    <div className="row clearfix">
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                            <div className="text">
                                                <p>Man therefore always holds these matters to this principle that rejects pleasures nothing prevents.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="single-item">
                                    <div className="row clearfix">
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                            <div className="text">
                                                <p>Cases are perfectly simple and easy  distinguish.</p>
