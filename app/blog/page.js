                ...
                <div className="auto-container">
                                ...
                                <div className="inner-box">
                                    ...
                                    <div className="lower-content">
                                        ...
                                        <ul className="post-info">
                                            <li><i className="flaticon-edit"></i><a href="/blog-details">Dustin Langer</a></li>
                            ...
                            <div className="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    ...
                                    <div className="lower-content">
                                        ...
                                        <ul className="post-info">
                                            <li><i className="flaticon-edit"></i><a href="/blog-details">Brendan Duke</a></li>
                    ...
                    <div className="pagination-wrapper centred">
                        <ul className="pagination clearfix">
                            <li><Link href="/blog"><i className="flaticon-left"></i></Link></li>
                            <li><Link href="/blog" className="current">01</Link></li>
                            <li><Link href="/blog">02</Link></li>
                            <li><Link href="/blog">03</Link></li>
                            <li><Link href="/blog"><i className="flaticon-right-arrow-1"></i></Link></li>
                        </ul>
                    </div>
                </div>
            </section>
